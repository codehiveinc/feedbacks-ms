...
class CreateFeedbackUseCase:
    ...
    def execute(self, content: str, user_uuid: str, meal_uuid: str):
        feedback_uuid = str(uuid.uuid4())
        feedback_entity = FeedbackEntity(uuid=feedback_uuid, content=content, user_uuid=user_uuid, meal_uuid=meal_uuid, rating=RatingEnum.GOOD, id=None, created_at=None, updated_at=None)
